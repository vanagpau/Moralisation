...
lag1 <- lavaanPlot::lavaanPlot(name = "title", cross.1.fit, labels = labels1, coefs = TRUE, sig = 0.05, stars = c("regress"), edge_options = list(color = "grey"))
lag1
...
lag2 <- lavaanPlot::lavaanPlot(name = "title", cross.2.fit, labels = labels2, coefs = TRUE, sig = 0.05, stars = c("regress"), edge_options = list(color = "grey"))
lag2
...
lag3 <- lavaanPlot::lavaanPlot(name = "title", cross.3.fit, labels = labels2, coefs = TRUE, sig = 0.05, stars = c("regress"), edge_options = list(color = "grey"))
lag3
