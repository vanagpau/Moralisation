...
# IV = hed; mod = emo + pig
med1 <- psych::mediate('behav_4', 'behav_1', m = c('emo_4', 'pig_4', 'moral_4'), data = wide_df)

# ERROR here for some reason
# summary(med1)

mediate.diagram(med1, main = "")
...
lavaanPlot::lavaanPlot(name = "title", cross.1.fit, , labels = labels1, coefs = TRUE)
...
lavaanPlot::lavaanPlot(name = "title", cross.1.fit, coefs = TRUE )
