...
# When model1 is replicated using this method, the effect of moral emotions becomes non-significant
...
# When moral cognitions is added it becomes very non-significant
...
# This model shows that without moral emotions, moral cognitions do become significant, therefore by inference play a greater role in predicting moralisation in this experiment

m1.4 <- lm(moral_4 ~ moral_1 + pig_delta_1 + cog_delta_1, data = wide_df)
summary(m1.4)
...
# Run model with cog + pig only -> AIC(327), still slightly worse than m10(324)
